...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		composer.gotoScene( "scene4", "zoomOutInFade", 300  )
...
function scene:create( event )
	...
	---------Q&A-----------------------
	text1 = display.newText( "What are data values passed to ", 160, 50, native.systemFontBold, 20 )
	text1:setFillColor( 255 )
	secondLine = display.newText("other parts of a program,", 160, 80, native.systemFontBold, 20 )
	thirdLine = display.newText("usually methods and functions?", 160, 110, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. Parameters ", 0, 0, native.systemFont, 20 )
	...
	answer2 = display.newText( "2. Condition ", 0, 0, native.systemFont, 20 )
