...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		composer.gotoScene( "scene9", "flip", 300  )
...
function scene:create( event )
	...
	image = display.newImage( "bg8.png" )
	...
	---------Q&A-----------------------
	text1 = display.newText( "What are the type of touch", 160, 50, native.systemFontBold, 20 )
	text1:setFillColor( 255 )
	secondLine = display.newText("events that display objects", 160, 80, native.systemFontBold, 20 )
	thridLine = display.newText("can listen for?", 160, 110, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. tap and touch", 0, 0, native.systemFont, 16 )
	...
	answer2 = display.newText( "2. press and tap ", 0, 0, native.systemFont, 16 )
