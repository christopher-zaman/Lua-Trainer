...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		composer.gotoScene( "scene8", "slideDown", 300  )
...
function scene:create( event )
	...
	image = display.newImage( "bg7.png" )
	...
	---------Q&A-----------------------
	text1 = display.newText( "Which of the following ", 160, 50, native.systemFontBold, 20 )
	text1:setFillColor( 255 )
	secondLine = display.newText("makes a circle with a radius", 160, 80, native.systemFontBold, 20 )
	thridLine = display.newText("40 and center at x = 50, y = 60?", 160, 110, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. myCircle = display.newCircle(50, 60, 40)", 0, 0, native.systemFont, 16 )
	...
	answer2 = display.newText( "2. myCircle = display.newCircle(40, 60, 50) ", 0, 0, native.systemFont, 16 )
