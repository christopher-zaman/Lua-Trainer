...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		...
		composer.gotoScene( "scene5", "fromRight", 400  )
...
function scene:create( event )
	...
	image = display.newImage( "bg4.png" )
	...
	text1 = display.newText( "What is a named pointer", 160, 50, native.systemFontBold, 20 )
	text1:setFillColor( 255 )
	secondLine = display.newText("to data in your", 160, 80, native.systemFontBold, 20 )
	thirdLine = display.newText("program that can change?", 160, 110, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. Variable ", 0, 0, native.systemFont, 22 )
	...
	answer2 = display.newText( "2. Argument ", 0, 0, native.systemFont, 22 )
...
function scene:show( event )
	...
	print( "4: show event, phase did" )
		...
		local showMem = function()
			...
			text2.x = display.contentWidth * 50
		end
