...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		composer.gotoScene( "scene7", "zoomOutInFadeRotate", 500  )
...
function scene:create( event )
	...
	image = display.newImage( "bg6.png" )
	...
	---------Q&A-----------------------
	text1 = display.newText( "Which one of the following", 160, 50, native.systemFontBold, 20 )
	text1:setFillColor( 255 )
	secondLine = display.newText("makes myRectangle green?", 160, 80, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. myRectangle:setFillColor(0, 1, 0) ", 0, 0, native.systemFont, 20 )
	...
	answer2 = display.newText( "2. myRect = (0, 1, 0) ", 0, 0, native.systemFont, 20 )
