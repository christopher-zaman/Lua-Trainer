...
local function onSceneTouch( self, event )
	if event.phase == "began" then
		composer.gotoScene( "scene6", "flipFadeOutIn", 300  )
...
function scene:create( event )
	...
	image = display.newImage( "bg5.png" )
	...
	---------Q&A-----------------------
	text1 = display.newText( "What are tests in a program", 160, 50, native.systemFontBold, 20 )
	secondLine = display.newText("that evaluate to true or false?", 160, 80, native.systemFontBold, 20 )
	...
	answer1 = display.newText( "1. Condition ", 0, 0, native.systemFont, 20 )
	...
	answer2 = display.newText( "2. For loop ", 0, 0, native.systemFont, 20 )
